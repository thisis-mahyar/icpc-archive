...
VALUES
    (
        ...
        '
        <p>
            A multi-digit column addition is a formula on adding two integers written
            like this:
        </p>
        <p>
        ...
        <p>
            ...
            not necessarily correct. We can erase any number of the columns so that the
            addition becomes correct. For example, in the following addition, we can
        ...
        <p>
            ...
            that the remaining formula becomes a correct addition.
        </p>
        ',
        '
        <p>
        ...
        '
        <p>
            For each test case, print a single line containing the minimum number of
            columns needed to be erased.
        </p>
        ',
        19
    );
