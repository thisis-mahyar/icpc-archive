...
VALUES
    (
        ...
        '
        <p>
            There are $n$ attendees in a conference, numbered 1 through $n$. Each of the
            first $m$ attendees (numbered 1 through $m$) has a car to drive home after
            the event. The remaining $n - m$ attendees who do not have a car, are going
            to get a ride to their homes with the help of the first $m$ attendees. Each
            of the first $m$ attendees can pick up at most one other attendee (from
            attendees $m + 1$ to $n$) and drive them to their house before going to
            their own home. You are given the distance matrix $D$ of the $n + 1$
        ...
        <p>
            ...
            attendee $t_i$ and takes them to their home before driving to their own
            home. Each attendee must be transferred by exactly one car.
        </p>
        ',
        25
    );
